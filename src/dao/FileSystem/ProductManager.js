...
const p1 = new Product ("Alimento 1","Alimento para perro",10000,"#1",2,"A",true,[]);
const p2 = new Product ("Alimento 2","Alimento para perro",11000,"#2",4,"A",true,[]);
const p3 = new Product ("Alimento 3","Alimento para perro",12000,"#3",5,"A",true,[]);
const p4 = new Product ("Alimento 4","Alimento para perro",13000,"#4",7,"A",true,[]);
...
export class ProductManager {
    ...
    await this.addProduct(p1, ['...']);
    await this.addProduct(p2, ['...']);
    await this.addProduct(p3, ['...']);
    await this.addProduct(p4, ['...']);
    }
}